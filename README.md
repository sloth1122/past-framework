...
| **Judge** 🔨 | Verifier | Claude Fable 5 (Claude Code) | 13-point checklist, independent verification via `claude -p` |
| **Rocky** 🦊 | Coach | GLM-5.2 (exec) | Bi-weekly PAST tuning, ±1 trust region |
